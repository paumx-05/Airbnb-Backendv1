    ...
    <header className="bg-slate-800/95 backdrop-blur-md border-b border-slate-700/50 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center bg-slate-700/50 rounded-full px-6 py-3 border border-slate-600/50 hover:border-slate-500/50 transition-all duration-200 max-w-md mx-8 flex-1">
        ...
        {/* Mobile Auth Buttons - Solo mostrar si no está autenticado */}
        {!isAuthenticated && (
